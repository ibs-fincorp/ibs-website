          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-12">
            ...
            <div className="lg:col-span-4 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-3 mt-6">
                <a
                  href="https://www.instagram.com/ibs_fincorp/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram"
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-white/20 bg-white/10 text-white hover:bg-gold-500 hover:text-black hover:border-gold-500 transition-colors"
                >
                ...
                <a
                  href="https://www.facebook.com/ibsfincorp.incetto/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-white/20 bg-white/10 text-white hover:bg-gold-500 hover:text-black hover:border-gold-500 transition-colors"
                ...
                <a
                  href="https://www.linkedin.com/company/92576044/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-white/20 bg-white/10 text-white hover:bg-gold-500 hover:text-black hover:border-gold-500 transition-colors"
                ...
                <a
                  href="https://www.youtube.com/@IBSFINCORP"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-white/20 bg-white/10 text-white hover:bg-gold-500 hover:text-black hover:border-gold-500 transition-colors"
